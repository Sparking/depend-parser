...
__attribute__((always_inline)) static inline void rb_set_parent(struct rb_node *rb, struct rb_node *p)
{
    rb->rb_parent_color = (size_t)(rb_color(rb) | (((char *)p) - ((char *)NULL)));
}

__attribute__((always_inline)) static inline void rb_set_color(struct rb_node *rb, unsigned color)
{
    rb->rb_parent_color = (size_t)((rb->rb_parent_color & ~1) | color);
}

__attribute__((always_inline)) static inline void rb_set_parent_color(struct rb_node *rb, struct rb_node *p,
            unsigned color)
{
...
__attribute__((always_inline)) static inline void rb_init_node(struct rb_node *rb)
{
...
__attribute__((always_inline)) static inline void rb_link_node(struct rb_node *node, struct rb_node *parent,
